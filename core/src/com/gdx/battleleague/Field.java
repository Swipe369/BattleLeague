...
public class Field {
    ...
    public void update()
    {
        if(InputHandler.isClicked()&& !(cell_arr[InputHandler.calcX()][InputHandler.calcY()].isEmpty()))
        {
            for (int i=InputHandler.calcX();i<=InputHandler.calcX()+cell_arr[InputHandler.calcX()][InputHandler.calcY()].getUnit().getMoveRange()&&i<=14;i++)
                for (int j=InputHandler.calcY();j<=InputHandler.calcY()+cell_arr[InputHandler.calcX()][InputHandler.calcY()].getUnit().getMoveRange()&&j<=8;j++)
                {
